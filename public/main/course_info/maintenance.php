...
<div class="sectiontitle">
    <a href="../course_copy/create_backup.php?<?php echo api_get_cidreq(); ?>">
        <?php echo Display::getMdiIcon(ActionIcon::EXPORT_ARCHIVE,'ch-tool-icon', null, ICON_SIZE_SMALL, get_lang('Create a backup')); ?>
        <?php echo get_lang('Create a backup'); ?>
    </a>
</div>
<div class="sectioncomment"><?php echo get_lang('Create a backupInfo'); ?></div>

<div class="sectiontitle">
    <a href="../course_copy/import_backup.php?<?php echo api_get_cidreq(); ?>">
        <?php echo Display::getMdiIcon(ActionIcon::IMPORT_ARCHIVE,'ch-tool-icon', null, ICON_SIZE_SMALL, get_lang('Import backup')); ?>
        <?php echo get_lang('Import backup'); ?>
    </a>
</div>
<div class="sectioncomment"><?php echo get_lang('Import backupInfo'); ?></div>

<div class="sectiontitle">
    <a href="../course_copy/import_moodle.php?<?php echo api_get_cidreq(); ?>">
        <?php echo Display::getMdiIcon(ActionIcon::IMPORT_ARCHIVE, 'ch-tool-icon', null, ICON_SIZE_SMALL, get_lang('Import from Moodle')); ?>
        <?php echo get_lang('Import from Moodle'); ?>
    </a>
</div>
<div class="sectioncomment"><?php echo get_lang('Import from MoodleInfo'); ?></div>
